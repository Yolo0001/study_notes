...
![](./img/c745c87f6eda9a439e0eea52012c7f4a.png)
...
![](./img/bd1d31be3779342427fc9e462bf7f05c.png)
...
![](/img/types-of-nosql-datastores.png)
...
![](img/c1c6375d08ca268690cef2b13591a5b4.png)
...
![](/img/image-20211008164229671.png)
...
![](/img/image-20211008164542347.png)
...
![](/img/image-20220510105408703.png)
...
![](/img/innodb-myisam-performance-comparison.png)
...
![](/img/comparison-of-common-mysql-storage-engines.png)
...
![](/img/mysql20210513092328171.png)

但是！哈希算法有个 **Hash 冲突** 问题，也就是说多个不同的 key 最后得到的 index 相同。通常情况下，我们常用的解决办法是 **链地址法**。链地址法就是将哈希冲突数据存放在链表中。就比如 JDK1.8 之前 `HashMap` 就是通过链地址法来解决哈希冲突的。不过，JDK1.8 以后`HashMap`为了减少链表过长的时候搜索时间过长引入了红黑树。

![](/img/mysql20210513092224836.png)
...
![](/img/mysql20210420165311654.png)

聚簇索引和非聚簇索引:

![](/img/mysql20210420165326946.png)
...
![](/img/mysql20210420165341868.png)
...
![](/img/not-using-covering-index-demo.png)
...
![](/img/using-covering-index-demo.png)
...
![](/img/2019-31-1脏读(读未提交)实例.jpg)

### 避免脏读(读已提交)

![](/img/2019-31-2读已提交实例.jpg)

### 不可重复读

还是刚才上面的读已提交的图，虽然避免了读未提交，但是却出现了，一个事务还没有结束，就发生了 不可重复读问题。

![](/img/2019-32-1不可重复读实例.jpg)

### 可重复读

![](/img/2019-33-2可重复读.jpg)
...
![](/img/13526879-3037b144ed09eb88.png)
