...
![](./img/img006.50c335ee.png)

##### [2]跨团队协作

<img src="./img/img007.fece732b.png" style="zoom:75%;" />

## 第三节 Git安装

<img src="./img/img008.94e3aa2b.png" style="zoom:75%;" />

<img src="./img/img009.86259628.png" style="zoom:75%;" />

<img src="./img/img010.9d06ee7f.png" style="zoom:75%;" />

<img src="./img/img011.5c8e24a9.png" style="zoom:75%;" />

<img src="./img/img012.9535eb9d.png" style="zoom:75%;" />

<img src="./img/img013.adfb40cc.png" style="zoom:75%;" />

<img src="./img/img014.bfb731be.png" style="zoom:75%;" />

<img src="./img/img015.20ffa8e2.png" style="zoom:75%;" />
...
<img src="./img/img017.3af1c0e1.png" style="zoom:75%;" />
...
<img src="./img/img018.d0d2dae9.png" style="zoom:75%;" />
...
<img src="./img/img019.298cce4c.png" style="zoom:75%;" />
...
<img src="./img/下载 (17).png" style="zoom:75%;" />

#### ④再次查看本地库状态

检测到有新建的文件添加到了暂存区

<img src="./img/下载 (18).png" style="zoom:75%;" />

#### ⑤将暂存区中的修改提交到本地库

<img src="./img/img022.c8d72987.png" style="zoom:75%;" />
...
<img src="./img/img024.f7f794ad.png" style="zoom:75%;" />

#### ②工作区文件修改后添加到暂存区

<img src="./img/下载 (20).png" style="zoom:75%;" />
...
![](./img/img026.533b8e5f.png)

#### ②切换到指定版本

<img src="./img/img027.5b85eb10.png" style="zoom:75%;" />

#### ③底层其实是移动HEAD指针

<img src="./img/下载 (21).png" style="zoom:75%;" />
...
<img src="./img/img029.2b9e80d6.png" style="zoom:75%;" />
...
<img src="./img/下载 (22).png" style="zoom:75%;" />
...
<img src="./img/img033.a7d16f5c.png" style="zoom:75%;" />

#### ②在两个不同分支分别做不同修改

<img src="./img/img034.57e41648.png" style="zoom:75%;" />

<img src="./img/下载 (23).png" style="zoom:75%;" />

#### ③分支合并

<img src="./img/img032.f3ed69e1.png" style="zoom:75%;" />
...
<img src="./img/img035.c3ca7935.png" style="zoom:75%;" />
...
<img src="./img/img039.2feaf394.png" style="zoom:75%;" />
...
<img src="./img/img036.79750def.png" style="zoom:75%;" />

##### [2]第二步

<img src="./img/下载 (24).png" style="zoom:75%;" />

使用git status命令查看本地库状态

<img src="./img/下载 (25).png" style="zoom:75%;" />

##### [3]第三步

执行提交（注意：使用git commit命令时不能带文件名）

<img src="./img/img038.2357f435.png" style="zoom:75%;" />

# 第三章 命令行远程库操作

## 第一节 创建远程库

![](./img/img042.05fc199c.png)

![](./img/img043.91458012.png)
...
<img src="./img/img044.c35f0dfa.png" style="zoom:48%;" />
...
![](./img/img045.b2332250.png)

### 2、推送

git push 别名 分支

![](./img/img046.b5b4d3f6.png)
...
![](./img/img048.1666f054.png)

### 3、克隆

团队其他人想拿到整个库就可以使用克隆功能。命令格式是：git clone 远程库地址

![](./img/img049.5045a656.png)
...
![](./img/img051.c568a675.png)

![](./img/img052.1f139a00.png)

![](./img/img053.a212cd57.png)

![](./img/img054.5ad343e3.png)

![](./img/下载 (28).png)

![](./img/img056.34519966.png)
...
![](./img/img061.65bde334.png)

### 7、通过拉取操作查看别人的修改

![](./img/img062.cdf4dc73.png)

## 第三节 跨团队协作

### 1、团队外：fork远程库

![](./img/img063.67963578.png)

![](./img/img066.3c88d349.png)

### 2、团队外：在fork仓库中修改代码

如果要修改的代码很多，可以先clone到本地，修改完成后再push。如果修改不多可以直接在线修改。

![](./img/img067.51e01a0c.png)

### 3、团队外：修改完成后发起pull request

![](./img/img069.2f7014f5.png)

![](./img/img070.577a5b1a.png)

创建后效果如下：

![](./img/img071.2256efc7.png)

### 4、团队内：审核代码

首先审核者通过站内通知获知pull request请求

![](./img/img073.99a259bd.png)
...
![](./img/img086.2677b27a.png)

### 2、初始化本地库

![](./img/img089.f8ca8d82.png)

## 第三节 添加与提交

### 1、添加到暂存区

![](./img/img091.e0a8644e.png)

### 2、提交到本地库

![](./img/img092.5d35ae7b.png)

![](./img/img093.61247f40.png)
...
![](./img/img098.e83cddc2.png)

![](./img/img099.d378e557.png)
...
![](./img/img118.bcb3ec58.png)

后面按照这个别名执行交互操作即可

![](./img/img119.a379bf7a.png)

## 7、IDEA中使用

### ①按照Gitlab插件

![](./img/img120.9f4cdea9.png)

### ②设置Gitlab插件

![](./img/img121.5e922a8a.png)

![](./img/img122.01e8b471.png)
